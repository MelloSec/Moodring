...
public class Virtualization
{
    ...
    public static bool Execute()
    {
        ...
        if (Virtualization.GetForegroundWindowAntiDebug())
        {
            Console.WriteLine("Foreground Window debugger detected.");
        }

        if (Virtualization.FindWindowAntiDebug())
        {
